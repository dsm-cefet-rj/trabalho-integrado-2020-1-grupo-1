...
Feature: Criar Competicao
 Cadastra uma nova competicao
  ...
  Scenario: Criar competicao
    ...
    When preenche os campos obrigatórios para cadastrar a nova competição:
         | nome                                  | dominio |                                           restricoes                                                           |
         | competition_name                      | String  |                                                                                                                |
         | competition_initials                  | String  |                                                                                                                |
         | competition_level                     | String  | Um dentre os seguintes valores: Livre, Bronze, Prata, Ouro, Platina, Diamante, Mestre, Grao-Mestre, Desafiante |
    ...
    Then a competicao e criada
    And a tela e redirecionada para a tela da Sua Competição(myCompetition)
