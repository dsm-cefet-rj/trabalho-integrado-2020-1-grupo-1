            ...
            <ul>
              <Dropdown drop={(width < 767.98) ? 'down' : 'right'}>
                ...
                <Dropdown.Menu variant="dropdown-menu" className="dropdown-menu" id="dropdown-menu" >
                  <Dropdown.Item variant="menu-dropdown-option" className="menu-dropdown-option" href="" id="">Editar perfil</Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
              ...
              <Dropdown drop={(width < 767.98) ? 'down' : 'right'}>
                ...
                <Dropdown.Menu variant="dropdown-menu" className="dropdown-menu" id="dropdown-menu">
                  <Dropdown.Item variant="menu-dropdown-option" className="menu-dropdown-option" href="" id="">Minha equipe</Dropdown.Item>
                </Dropdown.Menu>            
              </Dropdown>
              ...
              <Dropdown drop={(width < 767.98) ? 'down' : 'right'}>
                ...
                <Dropdown.Menu variant="dropdown-menu" className="dropdown-menu" id="dropdown-menu">
                  <Dropdown.Item variant="menu-dropdown-option" className="menu-dropdown-option" href="" id="">Ver competições</Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>              
            </ul>
            <div>
